...
#define COLOR_GREY                  (Color) {192, 192, 192,   0}
#define COLOR_DARK_GREY             (Color) {128, 128, 128,   0}
#define COLOR_VERY_DARK_GREY        (Color) { 64,  64,  64,   0}
#define COLOR_RED                   (Color) {255,   0,   0,   0}
#define COLOR_DARK_RED              (Color) {128,   0,   0,   0}
#define COLOR_VERY_DARK_RED         (Color) {64,    0,   0,   0}
#define COLOR_YELLOW                (Color) {255, 255,   0,   0}
#define COLOR_DARK_YELLOW           (Color) {128, 128,   0,   0}
#define COLOR_VERY_DARK_YELLOW      (Color) { 64,  64,   0,   0}
#define COLOR_GREEN                 (Color) {  0, 255,   0,   0}
#define COLOR_DARK_GREEN            (Color) {  0, 128,   0,   0}
#define COLOR_VERY_DARK_GREEN       (Color) {  0,  64,   0,   0}
#define COLOR_CYAN                  (Color) {  0, 255, 255,   0}
#define COLOR_DARK_CYAN             (Color) {  0, 128, 128,   0}
#define COLOR_VERY_DARK_CYAN        (Color) {  0,  64,  64,   0}
#define COLOR_BLUE                  (Color) {  0,   0, 255,   0}
#define COLOR_DARK_BLUE             (Color) {  0,   0, 128,   0}
#define COLOR_VERY_DARK_BLUE        (Color) {  0,   0,  64,   0}
#define COLOR_MAGENTA               (Color) {255,   0, 255,   0}
#define COLOR_DARK_MAGENTA          (Color) {128,   0, 128,   0}
#define COLOR_VERY_DARK_MAGENTA     (Color) { 64,   0,  64,   0}
